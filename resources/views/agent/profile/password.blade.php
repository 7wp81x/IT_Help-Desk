...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <form action="{{ route('agent.profile.password.update') }}" method="POST" class="p-6" id="passwordForm">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" name="current_password" id="current_password" required
                               class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-green-500 pr-10">
            ...
            <div class="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                <a href="{{ route('agent.profile') }}" class="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 transition">
                    Cancel
                </a>
                <button type="submit" id="submitBtn" class="px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition">
                    Update Password
                </button>
            </div>
        </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateStrengthBar() {
        ...
        const percentage = (metCount / Object.keys(requirements).length) * 100;
    ...
    if (passwordForm) {
        passwordForm.addEventListener('submit', function(e) {
            ...
            if (currentPasswordField) {
                ...
                if (!currentPassword) {
                    if (currentError) currentError.innerText = 'Current password is required.';
