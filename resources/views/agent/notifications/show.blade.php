...
<div class="max-w-4xl mx-auto px-4 py-10">
    <div class="flex items-center justify-between mb-6 gap-4">
        ...
        <a href="{{ route('agent.notifications') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 transition">
    ...
    <div class="rounded-3xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-950 shadow-sm overflow-hidden">
        <div class="p-6">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                @if(data_get($data, 'assigned_by'))
                    <div class="rounded-2xl bg-gray-50 dark:bg-gray-900 p-4">
                        <p class="text-xs uppercase tracking-[0.24em] text-gray-500 dark:text-gray-400">Assigned By</p>
                        <p class="mt-2 text-sm font-semibold text-gray-900 dark:text-white">{{ data_get($data, 'assigned_by') }}</p>
                    </div>
                @endif
            </div>
        </div>
