        ...
        <div style="background-color: #ecfdf5; border-left: 4px solid #10b981; padding: 15px; margin: 20px 0;">
            ...
            @if(isset($password) && $password)
                <p style="font-size: 14px; line-height: 1.6; color: #065f46; margin: 0 0 10px 0;">
                    Your agent account has been created automatically. Use the credentials below to log in, then update your password from your profile settings.
                </p>
                <p style="font-size: 14px; line-height: 1.6; color: #111827; font-weight: 700; margin: 0 0 5px 0;">
                    📧 Email: <span style="font-family: monospace;">{{ $user->email }}</span>
                </p>
                <p style="font-size: 14px; line-height: 1.6; color: #111827; font-weight: 700; margin: 0 0 10px 0;">
            ...
            @endif
            <p style="font-size: 14px; line-height: 1.6; color: #374151; margin: 10px 0 0 0;">
                <strong>Login URL:</strong> <a href="{{ url('/login') }}" style="color: #2563eb; text-decoration: none;">{{ url('/login') }}</a>
            </p>
        </div>
