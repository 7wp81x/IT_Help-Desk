...
@section('title', 'Create New End User')

@section('content')
<div class="max-w-4xl mx-auto">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Create End User</h1>
        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Add a new end user to the system</p>
    </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/30 flex justify-end gap-3">
                ...
                <button type="submit" 
                    ...
                    <i class="bi bi-plus-circle mr-2"></i> Create End User
                </button>
            </div>
        </form>
    </div>
